...
public class BazaDanychAktualizacja extends AppCompatActivity {
    ...
    public static final String EXTRA_ORGANIZACJA_ID = "organizacja";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            cursor = db.query("ORGANIZACJA", new String[] {"_id", "NAZWA", "RODZAJ"},
                    "_id = ?", new String[] {Integer.toString(organizacjaId)}, null, null, null);
            ...
            Toast toast = Toast.makeText(this,"Baza danych jest niedostepna", Toast.LENGTH_LONG);
            toast.show();
            finish();
        }
    }
    ...
    public void onClickZapisz(View view){
        ...
        db.update("ORGANIZACJA",obiektValues,"_id = ?",
                                                new String[] {Integer.toString(organizacjaId)});
        db.close();
        finish();
    }
